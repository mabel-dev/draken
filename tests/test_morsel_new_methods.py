...
class TestMorselNewMethods:
    """Test the new Morsel methods for API compatibility and basic functionality."""
    ...
    def test_take_method_signature(self):
    ...
    def test_select_method_signature(self):
    ...
    def test_rename_method_signature(self):
    ...
    def test_rename_wrong_number_names(self):
    ...
    def test_api_compatibility_with_pyarrow(self):
