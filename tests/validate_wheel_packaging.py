...
- This file is needed for: from draken.core.buffers cimport DrakenVarBuffer
...
def main():
    ...
    print("  1. Opteryx code: from draken.vectors.string_vector cimport _StringVectorCIterator")
    print("  2. string_vector.pxd: from draken.core.buffers cimport DrakenVarBuffer")
